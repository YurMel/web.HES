...
namespace HES.Infrastructure.Migrations
{
    ...
    [Migration("20190806115356_added_deviceAccessProfiles_table")]
    partial class added_deviceAccessProfiles_table
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HES.Core.Entities.Device", b =>
                {
                    ...
                    b.Property<string>("DeviceAccessProfileId");
                    ...
                    b.HasIndex("DeviceAccessProfileId");
            ...
            modelBuilder.Entity("HES.Core.Entities.DeviceAccessProfile", b =>
                {
                    ...
                    b.Property<int>("ButtonExpirationTimeout");
            ...
            modelBuilder.Entity("HES.Core.Entities.Device", b =>
                {
                    b.HasOne("HES.Core.Entities.DeviceAccessProfile")
                        .WithMany("Devices")
                        .HasForeignKey("DeviceAccessProfileId");
